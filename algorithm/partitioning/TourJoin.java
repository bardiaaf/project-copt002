...
public class TourJoin {
    ...
    private static Vertex getEndNode(Tour T, Vertex2D v) {
        Vertex v1 = T.next(v);
    ...
    private static Tour joinTours(Tour T1, Vertex start1, Vertex end1, Tour T2, Vertex start2, Vertex end2) {
    ...
    private static Cluster join(Cluster c1, Cluster c2) {
        Vertex2D v1 = c1.closestPoint(c2.getCentroid());
        Vertex2D v2 = c2.closestPoint(c1.getCentroid());

        Vertex end1 = getEndNode(c1.getTour(), v1);
        Vertex end2 = getEndNode(c2.getTour(), v2);


        Tour tour = joinTours(c1.getTour(), v1, end1, c2.getTour(), v2, end2);
    ...
    public static Tour joinClusterTours(List<Cluster> clusters) {
